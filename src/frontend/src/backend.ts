...
export class Backend implements backendInterface {
    ...
    async claimTask(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async generateTasks(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.generateTasks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getObjectives(): Promise<Array<Objective>> {
        if (this.processError) {
            try {
                const result = await this.actor.getObjectives();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWorkerStats(): Promise<Array<[Principal, bigint, number]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWorkerStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeDefaultObjectives(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeDefaultObjectives();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setObjective(arg0: string, arg1: string, arg2: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.setObjective(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitTask(arg0: bigint, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async triggerPayout(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.triggerPayout(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        isAIWorker: value.isAIWorker,
        status: value.status,
        title: value.title,
        submittedResult: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.submittedResult)),
        ...
        aiScore: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.aiScore))
    };
}
